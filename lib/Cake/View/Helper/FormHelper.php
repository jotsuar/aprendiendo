			...
			if ($name !== null) {
				...
				if ($showParents || (!in_array($title, $parents))) {
					...
					if ($attributes['style'] === 'checkbox') {
						...
						} elseif ($attributes['class'] === 'form-control') {
 ...
 * Will also add a 'form-control' class if the field contains validation errors.
 *
 * ### Options
 *
 ...
 */
	protected function _initInputField($field, $options = array()) {
		...
		if ($this->tagIsInvalid() !== false) {
			$result = $this->addClass($result, 'form-control');
		}

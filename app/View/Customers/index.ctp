				...
				<table cellpadding="0" cellspacing="0" class="table table-striped table-hover">
					<thead class="text-primary">
						<tr>						
								...
								<th><?php echo $this->Paginator->sort('telephone', __('Telephone')); ?></th>
								<th><?php echo $this->Paginator->sort('address', __('Address')); ?></th>
								<th><?php echo $this->Paginator->sort('document', __('Document')); ?></th>
								<th><?php echo $this->Paginator->sort('gender', __('Gender')); ?></th>
...
<?php 					 foreach ($customers as $customer): ?>
							<tr>
								...
								<td><?php echo h($customer['Customer']['document']); ?>&nbsp;</td>
								<td><?php echo h($customer['Customer']['gender']); ?>&nbsp;</td>
								<td> <?php echo $customer['Customer']['state'] == 1 ? __('Activo') : __('Inactivo') ;?> </td>									<td class="td-actions">
									    <a rel="tooltip" href="<?php echo $this->Html->url(array('action' => 'view',$customer['Customer']['id'])); ?>" title="<?php echo __('Ver'); ?>" class="btn btn-info  btn-xs">
									        <i class="fa fa-eye"></i>
									    </a>
									    <a rel="tooltip" href="<?php echo $this->Html->url(array('action' => 'edit',$customer['Customer']['id'])); ?>" title="<?php echo __('Editar'); ?>" class="btn btn-success btn-xs">
									        <i class="fa fa-edit"></i>
									    </a>
									    <a rel="tooltip" href="<?php echo $this->Html->url(array('action' => 'delete',$customer['Customer']['id'])); ?>" title="<?php echo $customer['Customer']['state'] == 1 ? __('Deshabilitar') : __('Habilitar'); ?>" class="btn btn-danger btn-xs changeState">
